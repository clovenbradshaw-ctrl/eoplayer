...
// Vendored from eoreader4 (the reader work). The reading engine is source-blind:
// it reads a stream of INS/CON events and never knows whether they came from a
// novel, a melody file, a live keyboard, or the generator. The one constant the
// conversation door needs is inlined here so the engine stays self-contained.
const CONVERSATIONAL_CAP = 0.6;
